...
public class BackpackScene implements Scene {
    @Override
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawRect(new RectF(Constants.SCREEN_WIDTH*2/3+5,Constants.SCREEN_HEIGHT*9/10,Constants.SCREEN_WIDTH,Constants.SCREEN_HEIGHT),paint);
